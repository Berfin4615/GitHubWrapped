        ...
        render: () => (
          <div className="text-center">
            <div className="text-6xl sm:text-7xl font-extrabold">
              <CountUp end={data.peakDay.count} duration={1.2} />
            </div>
            <div className="mt-3 text-white/90 text-lg">{data.peakDay.date ?? "-"}</div>
            <div className="mt-2 text-white/70 text-sm">contributions in one day</div>
          </div>
        ),
      },
      {
        ...
        render: () => (
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
              <button className="rounded-2xl bg-white/15 border border-white/20 px-6 py-3 text-sm font-semibold hover:bg-white/20">
                Export PNG (soon)
              </button>
              <button
